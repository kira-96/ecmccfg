...
require ecmccfg sandst_a "ENG_MODE=1,MASTER_ID=1,ECMC_VER=sandst_a"

# EP7041-4032    1Ch Stepper
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd,       "SLAVE_ID=1,HW_DESC=EP7041-4032"
...
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd,       "SLAVE_ID=2,HW_DESC=EP7041-0000"
